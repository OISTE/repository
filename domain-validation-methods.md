...
Validation logs include information about the method used for each domain. The validation is always conformant to the description of that method in the latest version of the Baseline Requirements.
...
| ----------------------------------------------- | ----------------------- | ----------------------------- | ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| Email to Domain Contact                         | 3.2.2.4.13 / 3.2.2.4.14 | Pre-1.0 (legacy method)       | WHOIS-based contacts deprecated progressively; WHOIS reliance restricted/removed around BR 1.8.x era (2021–2023) | Discontinued July 15, 2025 |
